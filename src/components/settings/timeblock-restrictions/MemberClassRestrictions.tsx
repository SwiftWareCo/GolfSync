  ...
  return (
    <>
      <div className="mb-4 flex flex-row items-center justify-between">
        <h3 className="text-lg font-medium">Member Class Restrictions</h3>
      ...
      {restrictions.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <h3 className="text-lg font-medium">No member class restrictions</h3>
          <p>Add restrictions to limit when certain member classes can book</p>
        </div>
      ) : (
        ...
        <Dialog open={isDialogOpen} onOpenChange={(open) => !open && handleCloseDialog()}>
          <DialogContent className="flex max-h-[90vh] min-h-[600px] max-w-4xl flex-col p-0">
            <DialogHeader className="px-6 pt-6">
              <DialogTitle>
                {editorMode === "create"
                  ? "Create Member Class Restriction"
                  : "Edit Member Class Restriction"}
              </DialogTitle>
            </DialogHeader>
      ...
      <DeleteConfirmationDialog
        ...
        title="Delete Member Class Restriction"
